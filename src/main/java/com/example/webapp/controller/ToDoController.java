...
public class ToDoController {
	...
	@PostMapping("/update")
	public String update(@Validated ToDoForm form,BindingResult bindingReslut,RedirectAttributes attributes) {
		// バリデーションチェック
		// 入力チェックNG：入力画面を表示する
		if (bindingReslut.hasErrors()) {
			// 更新画面の設定
			form.setIsNew(false);
			return "todo/form";
		}
	...
	public String deleteToDo(@PathVariable Integer id, RedirectAttributes attributes) {
